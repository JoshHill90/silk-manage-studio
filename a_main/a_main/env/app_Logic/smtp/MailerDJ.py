...
class AutoReply:
    ...
    email_host = os.getenv("PM_EMAIL_HOSTING")
    send_from = os.getenv("PM_EMAIL_USER")
    email_password = os.getenv("PM_EMAIL_PASSWORD")
    email_port = os.getenv("PM_EMAIL_PORT")
    email_backend = os.getenv("PM_EMAIL_BACKEND_SMTP")
    alart_email = os.getenv("PM_EMAIL_CONTACT")
    receive_email = os.getenv("PM_EMAIL_CONTACT")
    #------------------------#
