...
from a_main.env.app_Logic.untility.quick_tools import QuickStripe, DateFunction, Hexer, DocumentFunctions, ViewExtendedFunctions
from logs.logging_config import logging
import time
...
class UserLoginView(generic.CreateView):
	...
	success_url = reverse_lazy('o-gallery')
